...
const technologies = [
	{ name: 'Kotlin', icon: <SiKotlin size={20} color='#F18E33' /> },
	{ name: 'Android', icon: <SiAndroid size={20} color='#3DDC84' /> },
	...
	{ name: 'IA', icon: <FaBrain size={20} color='#FF8C00' /> },
	{
		name: 'Machine Learning (ML)',
		icon: <FaRobot size={20} color='#F28D35' />,
	},
