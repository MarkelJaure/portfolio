...
import { SiNextdotjs, SiTypescript, SiJavascript, SiExpress, SiNestjs, SiPhp, SiMongodb, SiPostgresql, SiMysql, SiGit, SiDocker, SiNginx } from "react-icons/si";

// El arreglo original de tecnologías
const technologies = [
